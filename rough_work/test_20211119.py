...
def nondominatedSort(population,ctype):
    nondominated_fronts = [[]]
    print("                  Doing initial comparisons, filling first non-dominated front...")
    ...
    print("                  ...Done.")
    print("                  Filling other non-dominated fronts...")
    i = 0
...
def createOffspringPopulation(population,dist_matrix,tsub=2,selection_prob=0.9,cxtype='pmx',mu_prob=0.05,ctype=1):
    ...
    child1 = None
    child2 = None
    print("                  Doing Tournament Selection of parents...")
    ...
    print("                  Doing crossover and mutation operations...")
    for pair in mating_pairs:
        if cxtype=='pmx':
            child1,child2 = partiallyMappedCrossover(pair[0],pair[1])
        elif cxtype=='cycx':
            child1,child2 = cyclicCrossover(pair[0],pair[1])
        else:
            child1,child2 = orderedCrossover(pair[0],pair[1])
